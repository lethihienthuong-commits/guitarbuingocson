...
export default function LienHePage() {
  return (
    ...
    >
      ...
      >
        <h3 className="mb-5 text-2xl font-medium text-green-800 dark:text-green-400">LIÊN HỆ</h3>
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-2xl font-medium text-green-800 dark:text-green-400">CẢM NGHĨ CỦA HỌC VIÊN</h3>
